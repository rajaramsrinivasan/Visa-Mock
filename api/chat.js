...
{"verdict":"LIKELY APPROVED","score":78,"summary":"Two sentences summarising the applicant's overall performance.","strengths":["specific strength referencing their actual answer","another strength"],"weaknesses":["specific weakness with detail","another weakness"],"tips":["actionable specific tip 1","actionable specific tip 2","actionable specific tip 3"],"risk_factors":["specific F1 red flag if any"]}
verdict must be exactly: "LIKELY APPROVED", "BORDERLINE", or "LIKELY REFUSED".
Key F1 risk factors to watch for: weak ties to home country, vague career plans, unclear funding, suspiciously well-rehearsed answers, close relatives in US, poor knowledge of chosen program.
Be honest, specific, and reference actual answers from the transcript.`;
